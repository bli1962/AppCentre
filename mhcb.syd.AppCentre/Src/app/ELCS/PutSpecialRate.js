$(document).ready(function () {
    ...
    $('#btnRefresh').click(function () {
        ...
        $.ajax({
            type: 'GET',
            url: origin + '//api/SpecialRate/getMizuhoRates',
            //url: dev + '/api/SpecialRate',
            //url: deploy + '/api/SpecialRate',
            dataType: 'json',
            data: {},
            //*****************************************************************************
            ...
            success: function (result) {
                ...
                $.each(result, function (index, value) {
                    var row = $('<tr><td>'
                        + value.CCY_CODE + '</td><td>'
                        + value.DKB_SPECIAL_RATE_USD + '</td></tr>'
                    );
            ...
            error: function (jQXHR) {
                ...
                if (jQXHR.status == "401") {
                    ...
                    $('#divMessageText').text(jQXHR.responseText);
                    $('#divModalHeader').text("MIZUHO Special Rate");
    ...
    $('#btnUpdate').click(function () {
        ...
        $.ajax({
            type: 'PUT',
            url: origin + '//api/SpecialRate/',
            dataType: 'json',
            data: {
                CcyCode: $('#txtCcyCode').val(),
                Rate: $('#txtRate').val(),
