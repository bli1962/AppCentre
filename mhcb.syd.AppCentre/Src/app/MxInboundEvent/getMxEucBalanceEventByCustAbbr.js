$(document).ready(function () {
    ...
    $('#btnGet').click(function () {
        ...
        $.ajax({
            type: 'GET',
            url: origin + '//api/EUCBalanceEvent/getEUCBalanceEventByCustAbbr',
            ...
            success: function (result) {
                ...
                $.each(result, function (index, value) {
                    var row = $('<tr><td>'
                        ...
                        + value.NominalAmount + '</td><td>'
                        + value.SettlementAmount + '</td><td>'
                        + value.Currency + '</td><td>'
                        + value.BorrowOrLend + '</td><td>'
                        + value.ClosingDate + '</td><td>'
                        + value.MaturityDate + '</td><td>'
                        + value.BatchNo + '</td></tr>'
                    );
