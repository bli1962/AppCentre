$(document).ready(function () {
    ...
    $('#btnGet').click(function () {
        ...
        $.ajax({
            type: 'GET',
            url: origin + '//api/FXSettlementInf/getFxDeliveryCorpSummaryByDate',
            //url: dev + '/api/FXSettlementInf/',
            //url: deploy + '/api/FXSettlementInf/',
            dataType: 'json',
            data: { "DeliverySummryDate": $('#DeliverySummryDate').val() },
            //data: guideStatus,
            ...
            success: function (result) {
                ...
                $.each(result, function (index, value) {
                    var row = $('<tr><td>'
                        + value.CCY + '</td><td>'
                        + value.Acct_Type + '</td><td>'
                        + value.totalNet + '</td></tr>');
