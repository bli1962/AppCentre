...
namespace mhcb.syd.DataService.Controllers.api
{
	...
	public class EDocumentController : ApiController
	{
        ...
        //GET:  http://localhost:62001//api/EDocument/Pending/?eDocType=CurrentAndSavingsStatement
        [EnableCors("*", "*", "*")]
        //[BasicAuthentication]
        //[Authorize]
        [Route("Pending")]
        ...
        {
            var entry = EDocumentBusiness.GetPendingTrans(eDocType, optDate);
		...
		{
			var entry = EDocumentBusiness.updateStatus(eDocAttribute);
